import { BACnetMessage, BACnetMessageHeader, IAMResult, WhoIsResult, BACNetEventInformation, BACNetAlarm, ServiceMessage, SimpleAckPayload, CovNotifyPayload, AtomicFilePayload, SubscribeCovPayload, DeviceCommunicationControlPayload, ReinitializeDevicePayload, EventNotifyDataResult, ReadRangePayload, ObjectOperationPayload, ListElementOperationPayload, PrivateTransferPayload, RegisterForeignDevicePayload, BvlcResultPayload, WhoHasPayload, TimeSyncPayload, IHavePayload, ConfirmedTransactionOutcome, BACNetObjectID, WritePropertyRequest, ReadPropertyRequest } from './types';
...
export interface BACnetClientEvents {
    ...
    fdrRegistered: (content: BaseEventContent & {
        payload: {
            address: string;
            ttl: number;
            expiresAt: number;
    ...
    fdrExpiring: (content: BaseEventContent & {
        payload: {
            address: string;
            ttl: number;
            expiresAt: number;
    ...
    fdrExpired: (content: BaseEventContent & {
        payload: {
            address: string;
            ttl: number;
            expiredAt: number;
    ...
    forwardedNpduDroppedNoFdr: (content: BaseEventContent & {
        payload: {
            address: string;
        };
    }) => void;
