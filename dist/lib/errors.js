...
exports.SegmentAckTimeoutError = exports.SegmentCountExceededError = exports.InvalidSegmentedRequestError = exports.InvokeIdInUseError = exports.ApduTooLargeError = void 0;
...
class InvokeIdInUseError extends Error {
    peer;
    invokeId;
    service;
    constructor(options) {
        super(`ERR_INVOKE_ID_IN_USE - invokeId ${options.invokeId} is still pending toward peer ${options.peer}`);
...
exports.InvokeIdInUseError = InvokeIdInUseError;
