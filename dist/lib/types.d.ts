...
export type BACNetWritePropertyValues = BACNetAppData[] | BACNetWeeklySchedulePayload | BACNetExceptionSchedulePayload | BACNetEffectivePeriodPayload | BACNetCalendarDateListPayload;
