...
import { type ApplicationTag, type EventState, type EventType, type NotifyType, type ObjectType, type PropertyIdentifier, type TimeStamp, type EngineeringUnits, type DeviceStatus, type Segmentation, type Reliability, type BinaryPV, type NodeType, CovType } from './enum';
...
export type BACNetDateAppData = Omit<BACNetAppData<ApplicationTag.DATE>, 'value'> & {
...
export interface BACNetWeekNDayAppData extends BACNetAppData<ApplicationTag.WEEKNDAY> {
    value: BACNetWeekNDayValue;
}
export interface BACNetDateRangeAppData extends BACNetAppData<ApplicationTag.DATERANGE> {
...
export interface BACNetSpecialEventEntry {
    date: BACNetDateAppData | BACNetDateRangeAppData | BACNetWeekNDayAppData | BACNetAppData<ApplicationTag.OBJECTIDENTIFIER, BACNetObjectID>;
...
export type BACNetCalendarDateListEntry = BACNetDateAppData | BACNetDateRangeAppData | BACNetWeekNDayAppData;
export type BACNetCalendarDateListPayload = BACNetCalendarDateListEntry[];
export type BACNetArraySizeValue = number | BACNetAppData<ApplicationTag.UNSIGNED_INTEGER, number>;
export type BACNetWeeklyScheduleWriteValue = BACNetWeeklySchedulePayload | BACNetTimeValueEntry[] | BACNetArraySizeValue;
export type BACNetExceptionScheduleWriteValue = BACNetExceptionSchedulePayload | BACNetSpecialEventEntry | BACNetArraySizeValue;
...
export type BACNetWritePropertyValues = BACNetAppData[] | BACNetWeeklyScheduleWriteValue | BACNetExceptionScheduleWriteValue | BACNetEffectivePeriodWriteValue | BACNetCalendarDateListWriteValue;
export interface ApplicationTagValueTypeMap {
    ...
    [ApplicationTag.ENUMERATED]: ObjectType | EventState | EngineeringUnits | PropertyIdentifier | DeviceStatus | Segmentation | Reliability | BinaryPV | NodeType;
...
export type LogRecordValue = number | boolean | BACNetBitString | null | string | BACNetObjectID | Buffer | Date | LogRecordFailure;
