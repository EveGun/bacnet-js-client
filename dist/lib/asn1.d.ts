import { EncodeBuffer, BACNetReadAccessSpecification, BACNetBitString, BACNetPropertyState, BACNetDevObjRef, Decode, Tag, ObjectId, ApplicationData, BACNetReadAccess, ReadAccessDecode, CharacterString, ReadAccessSpec, ContextCharacterString, BACNetDateValue, BACNetEncodableAppData, LogRecord } from './types';
...
export declare const decodeWeeklySchedule: (buffer: Buffer, offset: number, apduLen: number, closingTagNumber?: number) => Decode<any[]> | undefined;
export declare const decodeExceptionSchedule: (buffer: Buffer, offset: number, apduLen: number, closingTagNumber?: number) => Decode<any[]> | undefined;
export declare const decodeScheduleEffectivePeriod: (buffer: Buffer, offset: number, apduLen: number, closingTagNumber?: number, openingTagNumber?: number) => Decode<any[]> | undefined;
export declare const decodeCalendarDatelist: (buffer: Buffer, offset: number, apduLen: number, closingTagNumber?: number, openingTagNumber?: number) => Decode<any[]> | undefined;
export declare const decodeRange: (buffer: Buffer, offset: number, maxOffset: number) => Decode<LogRecord[]> | undefined;
