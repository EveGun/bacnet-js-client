...
export declare const encodeHostNPort: (buffer: EncodeBuffer, value: BACNetHostNPort) => void;
export declare const decodeHostNPort: (buffer: Buffer, offset: number, maxOffset: number) => Decode<BACNetHostNPort> | undefined;
