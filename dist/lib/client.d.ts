...
import { BACNetAddress, BACNetObjectID, BACNetPropertyID, BACNetAppData, BACNetWritePropertyValues, BACNetTimestamp, ClientOptions, WhoIsOptions, WhoHasOptions, ServiceOptions, ReadPropertyOptions, WritePropertyOptions, WriteFileOptions, DecodeAcknowledgeSingleResult, DecodeAcknowledgeMultipleResult, BACNetReadAccessSpecification, DeviceCommunicationOptions, ReinitializeDeviceOptions, EncodeBuffer, BACNetEventInformation, BACNetReadAccess, BACNetAlarm, BACNetBitString, PropertyReference, TypedValue, WritePropertyMultipleObject, DecodeAtomicWriteFileResult, DecodeAtomicReadFileResult, ReadRangeAcknowledge, ReadRangeOptions, EnrollmentOptions, EnrollmentSummaryAcknowledge, EventNotifyDataParams, AcknowledgeAlarmOptions } from './types';
export default class BACnetClient extends TypedEventEmitter<BACnetClientEvents> {
    private _settings;
    private _transport;
    private _pendingForeignDeviceRegistrations?;
    private _activeForeignDeviceRegistrations?;
    private _invokeCounters?;
    private _activeInvokeIds?;
    private _linkQueues?;
    private _requestManager;
    private _pendingRequestMaxSegments?;
    private _segmentAssemblyStates?;
    private _outgoingSegmentTransactions?;
    private _isClosed;
    ...
    private _releaseInvokeId;
    private _getLinkQueues;
    private _runSerializedOnLink;
    ...
    private _sendConfirmedRequest;
    private _emitTransactionOutcome;
    private _dispatchConfirmedRequest;
    private _sendSegmentedConfirmedRequest;
    private _sendSegment;
    private _sendSegmentWindow;
    private _restartSegmentTimer;
    private _onSegmentAckTimeout;
    ...
    private _isForeignDeviceRegistrationActive;
    ...
    whoHas(receiverOrOptions?: BACNetAddress | WhoHasOptions, options?: WhoHasOptions): void;
    ...
    writeFile(receiver: BACNetAddress, objectId: BACNetObjectID, position: number, fileBuffer: number[][], options?: WriteFileOptions): Promise<DecodeAtomicWriteFileResult>;
    ...
    readRange(receiver: BACNetAddress, objectId: BACNetObjectID, idxBegin: number, quantity: number, options?: ReadRangeOptions): Promise<ReadRangeAcknowledge>;
    ...
    acknowledgeAlarm(receiver: BACNetAddress, objectId: BACNetObjectID, eventState: number, ackText: string, evTimeStamp: BACNetTimestamp, ackTimeStamp: BACNetTimestamp, options: AcknowledgeAlarmOptions): Promise<void>;
    ...
    rejectResponse(receiver: BACNetAddress, invokeId: number, rejectReason: number): void;
    abortResponse(receiver: BACNetAddress, invokeId: number, abortReason: number, isServer?: boolean): void;
